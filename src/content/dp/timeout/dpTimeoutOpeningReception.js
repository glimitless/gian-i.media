...
const dpTimeoutOpeningReception = [
  {
    type: 'image',
    lowRes: dpTimeoutOpeningReceptionImage1LowRes,
    highRes: dpTimeoutOpeningReceptionImage1HighRes,
    alt: '',
    id: 'timeout-opening-reception-photo-1',
  },
  {
    type: 'image',
    lowRes: dpTimeoutOpeningReceptionImage2LowRes,
    highRes: dpTimeoutOpeningReceptionImage2HighRes,
    alt: '',
    id: 'timeout-opening-reception-photo-2',
  },
  {
    type: 'image',
    lowRes: dpTimeoutOpeningReceptionImage3LowRes,
    highRes: dpTimeoutOpeningReceptionImage3HighRes,
    alt: '',
    id: 'timeout-opening-reception-photo-3',
  },
  {
    type: 'image',
    lowRes: dpTimeoutOpeningReceptionImage4LowRes,
    highRes: dpTimeoutOpeningReceptionImage4HighRes,
    alt: '',
    id: 'timeout-opening-reception-photo-4',
  },
  {
    type: 'image',
    lowRes: dpTimeoutOpeningReceptionImage5LowRes,
    highRes: dpTimeoutOpeningReceptionImage5HighRes,
    alt: '',
    id: 'timeout-opening-reception-photo-5',
  },
  {
    type: 'image',
    lowRes: dpTimeoutOpeningReceptionImage6LowRes,
    highRes: dpTimeoutOpeningReceptionImage6HighRes,
    alt: '',
    id: 'timeout-opening-reception-photo-6',
  },
];

export default dpTimeoutOpeningReception;