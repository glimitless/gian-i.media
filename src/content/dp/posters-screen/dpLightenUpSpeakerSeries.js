...
const dpLightenUpSpeakerSeries = [
  {
    type: 'image',
    lowRes: dpLUFigurativelySpeakingLowRes,
    highRes: dpLUFigurativelySpeakingHighRes,
    alt: '',
    id: 'dp-lu-figuratively-speaking',
  },
  {
    type: 'image',
    lowRes: dpLUOneLovelyHourLowRes,
    highRes: dpLUOneLovelyHourHighRes,
    alt: '',
    id: 'dp-lu-one-lovely-hour',
  },
  {
    type: 'image',
    lowRes: dpLUMaterialMemoryLowRes,
    highRes: dpLUMaterialMemoryHighRes,
    alt: '',
    id: 'dp-lu-material-memory',
  },
];

export default dpLightenUpSpeakerSeries;