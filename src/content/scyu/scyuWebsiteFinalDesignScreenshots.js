...
const scyuWebsiteFinalDesignScreenshots = [
  {
    type: 'image',
    lowRes: scyuWebsiteFinalDesignScreenshot1LowRes,
    highRes: scyuWebsiteFinalDesignScreenshot1HighRes,
    alt: '',
    id: 'website-design-sc-1',
  },
  {
    type: 'image',
    lowRes: scyuWebsiteFinalDesignScreenshot2LowRes,
    highRes: scyuWebsiteFinalDesignScreenshot2HighRes,
    alt: '',
    id: 'website-design-sc-2',
  },
  {
    type: 'image',
    lowRes: scyuWebsiteFinalDesignScreenshot3LowRes,
    highRes: scyuWebsiteFinalDesignScreenshot3HighRes,
    alt: '',
    id: 'website-design-sc-3',
  },
  {
    type: 'image',
    lowRes: scyuWebsiteFinalDesignScreenshot4LowRes,
    highRes: scyuWebsiteFinalDesignScreenshot4HighRes,
    alt: '',
    id: 'website-design-sc-4',
  },
  {
    type: 'image',
    lowRes: scyuWebsiteFinalDesignScreenshot5LowRes,
    highRes: scyuWebsiteFinalDesignScreenshot5HighRes,
    alt: '',
    id: 'website-design-sc-5',
  },
  {
    type: 'image',
    lowRes: scyuWebsiteFinalDesignScreenshot6LowRes,
    highRes: scyuWebsiteFinalDesignScreenshot6HighRes,
    alt: '',
    id: 'website-design-sc-6',
  },
];

export default scyuWebsiteFinalDesignScreenshots;