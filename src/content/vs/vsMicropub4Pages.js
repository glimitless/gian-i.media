...
const vsMicropub4Pages = [
  {
    type: 'image',
    lowRes: micropublication4Page1LowRes,
    highRes: micropublication4Page1HighRes,
    alt: '',
    id: 'vs-micropub-4-page-1',
  },
  {
    type: 'image',
    lowRes: micropublication4Page2LowRes,
    highRes: micropublication4Page2HighRes,
    alt: '',
    id: 'vs-micropub-4-page-2',
  },
];

export default vsMicropub4Pages;