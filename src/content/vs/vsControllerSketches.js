...
const vsControllerSketchesPages = [
  {
    type: 'image',
    lowRes: vsControllerSketchesPage1LowRes,
    highRes: vsControllerSketchesPage1HighRes,
    alt: '',
    id: 'vs-controller-sketches-page-1',
  },
  {
    type: 'image',
    lowRes: vsControllerSketchesPage2LowRes,
    highRes: vsControllerSketchesPage2HighRes,
    alt: '',
    id: 'vs-controller-sketches-page-2',
  },
  {
    type: 'image',
    lowRes: vsControllerSketchesPage3LowRes,
    highRes: vsControllerSketchesPage3HighRes,
    alt: '',
    id: 'vs-controller-sketches-page-3',
  },
  {
    type: 'image',
    lowRes: vsControllerSketchesPage4LowRes,
    highRes: vsControllerSketchesPage4HighRes,
    alt: '',
    id: 'vs-controller-sketches-page-4',
  },
];

export default vsControllerSketchesPages;